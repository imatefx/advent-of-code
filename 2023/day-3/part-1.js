...
getAllSpecialCharAdjacents = (engineSpecialCharMap) => {
	...
	Object.keys(engineSpecialCharMap).forEach((line, idx) => {
		engineSpecialCharMap[line].forEach((charIdx) => {
			if (charIdx !== null) {
				let data = getAdjacents(+line, charIdx);
